...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $studentId = $_POST['id'];
    $updatedNamaLengkap = mysqli_real_escape_string($conn, $_POST['Nama_Lengkap']);
    $updatedNIK = mysqli_real_escape_string($conn, $_POST['NIK']);

    $sql_update = "UPDATE siswa SET Nama_Lengkap='$updatedNamaLengkap', NIK='$updatedNIK' WHERE id=$studentId";
    $result_update = mysqli_query($conn, $sql_update);

    if ($result_update) {
        // Jika data berhasil diperbarui, tampilkan notifikasi menggunakan JavaScript
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Nama_Lengkap" value="<?php echo $studentData['Nama_Lengkap']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                            <label for="NIS" class="form-label">NIS:</label>
                            <input type="text" class="form-control" name="NIS" value="<?php echo $studentData['NIS']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Agama" value="<?php echo $studentData['Agama']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Status_dalam_keluarga" value="<?php echo $studentData['Status_dalam_keluarga']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                            <label for="Ayah" class="form-label">Nama Ayah:</label>
                            <input type="text" class="form-control" name="Ayah" value="<?php echo $studentData['Ayah']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="NISN" value="<?php echo $studentData['NISN']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                            <label for="NIK" class="form-label">NIK:</label>
                            <input type="text" class="form-control" name="NIK" value="<?php echo $studentData['NIK']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Ibu" value="<?php echo $studentData['Ibu']; ?>" required readonly>
                        </div>
                        <div class="mb-3">
